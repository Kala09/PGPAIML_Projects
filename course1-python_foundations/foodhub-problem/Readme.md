...
1. Environment: Python 3.10+, Jupyter Notebook.
2. Libraries: pandas, numpy, matplotlib, seaborn.
3. Data preparation: dtype checks, missing‑value audit; rating coerced to numeric (errors='coerce') to handle “Not given”.
4. EDA: Univariate (histograms/count plots), bivariate (grouped means, scatter), and correlation heatmap among cost_of_the_order, rating, food_preparation_time, delivery_time.
