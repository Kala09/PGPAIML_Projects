...
Demand shape: When, what, and from whom do customers order?
Service performance: How fast is food prepared and delivered; what are the outliers?
Customer satisfaction: What do ratings reveal (and where are the blind spots)?
Revenue levers: Which pricing/commission thresholds and partnerships drive margin?
Dataset
...
Weekend ops surge plan: Add rider/kitchen capacity and micro‑batch dispatching on Fri‑Sun to trim the ~3‑minute weekend delivery delta.
Feedback coverage: App nudges and small incentives to lift rating coverage; target +20–30 pp improvement to de‑bias satisfaction analytics.
Partnerships: Deepen co‑marketing with top restaurants/cuisines; negotiate service‑level guarantees in exchange for placement.
Portfolio growth: Time‑boxed promos for niche cuisines (bundles, discovery banners) to broaden basket diversity.
Outlier control: Real‑time monitoring to flag prep+delivery > P95 with root‑cause categorization (kitchen, routing, surge, item mix).
